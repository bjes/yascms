...
def setup_models(dbsession):
    ...
    dbsession.add(models.navbar.NavbarModel(name='臺北市政府教育局', order=1, type=2, icon='fa-university', ancestor=outside_link, url='https://www.doe.gov.taipei/'))
    dbsession.add(models.navbar.NavbarModel(name='臺北市政府', order=2, type=2, icon='fa-globe-asia', ancestor=outside_link, url='https://www.gov.taipei'))
