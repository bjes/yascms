...
def import_test_db_data(ini_file_path):
    ...
    session.query(SiteConfigModel).filter_by(name='site_phone').update({'value': '85021571'})
    session.query(SiteConfigModel).filter_by(name='site_fax').update({'value': '85011146'})
