...
from tp_yass.helpers.backend import file
from tp_yass import helpers
...
def test_upload_attachment_should_save_file_and_return_file_name(mocker, datadir):
    ...
    mocker.patch('tp_yass.helpers.backend.file.NamedTemporaryFile').return_value.__enter__.return_value.name = f'/tmp/what/ever/{dest_file_name_base}.{upload_file_name_suffix}'
